...
app.onReady = function () {
  if (!app.ready) {
    ...
    app.pubTopic = 'hannasofia/' + app.uuid + '/evt' // We publish to our own device topic
    app.subTopic = 'hannasofia/+/evt' // We subscribe to all devices using "+" wildcard
    app.setupCanvas()
    app.setupConnection()
    app.ready = true
  }
